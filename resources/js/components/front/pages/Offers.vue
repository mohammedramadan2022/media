...
let has_offers_pagination = computed(() => store.state.product.has_offers_pagination);
                ...
                <div class="row gy-3 gy-xl-0">
                    ...
                    <div class="col-xl-3">
                        <sections-with-categories :sections="sections">
                            <router-link @click="store.dispatch('getAllOffers')" :to="{name: 'offers'}" class="offers">
                    ...
                    <div class="col-xl-9">
                        ...
                        <div class="main-filter-div">
                            <form @submit.prevent="store.dispatch('getFilteredOffers')">
                                <div class="row justify-content-end">
                                    <div class="col-md-4 col-xl-4">
                                        <div class="mb-3">
                                            <label for="city" class="form-label" v-text="$t('message.city')"></label>
                                            <select class="form-select" v-model="filterData.city_id" id="city_id">
                        ...
                        <div class="row text-center text-md-start justify-content-md-between align-items-center results-info">
                            ...
                            <div class="col-md-auto">
                                <div class="row g-2 row-cols-auto justify-content-center align-items-center">
                                    ...
                                    <div class="col">
                                        <select class="form-select" @change="store.commit('filterOfferedProducts', $event.target.value)">
                        ...
                        <div v-if="allProducts.length === 0" class="main-filter-div">
                            <div class="alert alert-info text-center" v-text="$t('message.noVar', {var: $t('message.aProducts')})"></div>
                        </div>

                        <!-- show more -->
                        <div class="text-center" v-if="has_offers_pagination && allProducts.length > 0">
                            <a href="javascript:void(0);" @click.prevent="store.dispatch('getOffersNextPage')" class="show-more-link">
