            ...
            <div class="container">
                <div class="row gy-3 gy-xl-0">
                    ...
                    <div class="col-xl-3">
                        ...
                        <category-options from="products" :current-route="route"/>
                    </div>
                    ...
                    <div class="col-xl-9">
                        ...
                        <div class="row g-3 main-filter-div row-cols-1" v-if="allProducts.length === 0">
                            <div class="alert alert-info text-center" v-text="$t('message.noProducts')"></div>
                        </div>

                        <!-- show getProductsNextPage more -->
                        <div class="text-center" v-if="has_pagination && allProducts.length > 0">
                        ...
                        <div class="text-center" v-if="has_filter_pagination && allProducts.length > 0">
                        ...
                        <div class="text-center" v-if="has_category_pagination && allProducts.length > 0">
                            <a href="javascript:void(0);" @click.prevent="store.dispatch('getCategoryProductsNextPage')" class="show-more-link">
                                {{$t('message.loadMore')}}<i class="fa fa-arrow-down ms-2"></i>
                            </a>
                        </div>
                    </div>
