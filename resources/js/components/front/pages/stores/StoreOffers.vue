...
store.dispatch('getOffersByStoreId', store_id.value);
    ...
    <app-layout>
        <template #nav>
            <li class="breadcrumb-item">
                <router-link :to="{name: 'store-details', params: {id: store_id}}" v-text="$t('message.store')"></router-link>
            </li>
            <li class="breadcrumb-item active">
                <router-link :to="{name: $route.name}" v-text="$t('message.storeOffers')"></router-link>
            </li>
        </template>
        ...
        <section id="content">
            <div class="container">
                <div class="row gy-3 gy-xl-0">
                    <!-- sections filter -->
                    <div class="col-xl-3">
                        <store-sections-with-categories :sections="sections">
                            <router-link :to="{name: route.name}" class="offers">
                    ...
                    <div class="col-xl-9">
                        ...
                        <div class="main-filter-div">
                            <form @submit.prevent="store.dispatch('getStoreFilteredOffers', store_id)">
                                <div class="row justify-content-end">
                                    <div class="col-md-4 col-xl-4">
                                        <div class="mb-3">
                                            <label for="city" class="form-label" v-text="$t('message.city')"></label>
                                            <select class="form-select" id="city" v-model="filterData.city_id">
                                    ...
                                    <div class="col-md-12 col-xl-12">
                                        <div class="mb-3">
                                            <input type="text" v-model="filterData.term" class="form-control" :placeholder="$t('message.productName')">
                                        </div>
                                    </div>
                        ...
                        <div class="row text-center text-md-start justify-content-md-between align-items-center results-info">
                            ...
                            <div class="col-md-auto">
                                <div class="row g-2 row-cols-auto justify-content-center align-items-center">
                                    ...
                                    <div class="col">
                                        <select class="form-select my-normal-picker">
                        ...
                        <div class="text-center" v-if="has_pagination">
                            <a href="javascript:void(0);" @click.prevent="store.dispatch('getOffersByStoreIdNextPage', store_id)" class="show-more-link">
