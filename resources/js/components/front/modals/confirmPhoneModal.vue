...
<template>
    <div class="modal fade" id="confirmPhoneModal" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form @submit.prevent="store.dispatch('confirmPhonePhone')">
                        <!-- mobile -->
                ...
                <div class="modal-footer">
                    <div class="other-options">
                        <a href="#" @click="store.dispatch('resendActivePhoneCode')" class="resend" v-if="countDown === 0">
