...
let digits = computed(() => store.state.providers.digits);
</script>

<template>
    <div class="modal fade" id="confirmJoinModal" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <h1 v-text="$t('message.confirmJoinModal')" style="margin-top: 14px;"></h1>

                    <span v-text="$t('message.confirmMobileMessage')"></span>

                    <form @submit.prevent="store.dispatch('confirmJoinModal')">
                        <!-- mobile -->
                ...
                <div class="modal-footer">
                    <div class="other-options">
                        <a href="javascript:void(0);" @click="store.dispatch('resendConfirmPhoneCode')" class="resend" v-if="countDown === 0">
