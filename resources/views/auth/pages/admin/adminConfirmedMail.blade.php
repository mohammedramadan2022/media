                ...
                <div class="card-body p-4">
                    ...
                    <div class="mt-3 text-center">
                        <svg version="1.1" xmlns:x="&ns_extend;" xmlns:i="&ns_ai;" xmlns:graph="&ns_graphs;"
                             ...
                             style="height: 120px;" xml:space="preserve">
                                        <style type="text/css">
                                            .st0{fill:#FFFFFF;}
                                            .st1{fill:#5f634a;}
                                            .st2{fill:#FFFFFF;stroke:#5f634a;stroke-width:2;stroke-miterlimit:10;}
                        ...
                        <p class="text-muted font-14 mt-2">
                            تم إرسال رسالة بريد إلكتروني علي <b>{{ session()->has('email') ? session('email') : 'site@mail.com' }}
                                <br></b>. من فضلك تاكد من الكود المرسال اليك ,,,,
                            </p>

                            <a href="{{ route('admin-panel') }}" class="btn btn-block btn-main-color waves-effect waves-light mt-3">العودة للرئيسية</a>
                        </div>
...
{{--                </a>--}}
{{--                <p class="text-muted mt-2 mb-4">لوحة التحكم الرئيسية</p>--}}
{{--            </div>--}}
...
{{--                    <a href="{{ route('admin-panel') }}" class="btn btn-block btn-pink waves-effect waves-light mt-3">العودة للرئيسية</a>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </div>--}}
{{--    </div>--}}
