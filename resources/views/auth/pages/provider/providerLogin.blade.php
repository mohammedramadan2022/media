        ...
        <div class="col-md-8 col-lg-6 col-xl-5">
            <div class="card">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="text-center w-75 m-auto">
                        ...
                        <p class="text-muted mb-4 mt-3">أدخل عنوان بريدك الإلكتروني وكلمة المرور للوصول إلى لوحة المتجر الخاص بك.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('provider.submit.login') }}">
                        ...
                        <div class="form-group mb-3">
                            <label for="emailaddress" style="float: {{ floating() }};">@lang('back.form-email')</label>
                        ...
                        <div class="form-group mb-3" style="float: {{ floating() }};">
            ...
            <div class="row mt-3">
                <div class="col-12 text-center">
                    <p> <a href="{{ route('provider.forget-password') }}" class="text-muted ml-1">نسيت كلمة المرور ؟</a></p>
                </div>
            </div>
        </div>
    </div>
