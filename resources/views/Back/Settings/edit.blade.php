...
@section('title', trans('back.edit-var',['var'=>trans('back.setting')]))
...
@section('content')
    ...
    <div class="page-header page-header-default">
        <div class="page-header-content">
            <div class="page-title">
                <h4>
                    ...
                    <span class="text-semibold">@lang('back.home')</span> - @lang('back.edit-var',['var'=>trans('back.setting')])
                </h4>
            </div>
        </div>
        ...
        <div class="breadcrumb-line">
            <ul class="breadcrumb" style="float: {{ floating('right','left') }};">
                ...
                <li class="active">@lang('back.edit-var',['var'=>trans('back.setting')])</li>
            </ul>
    ...
    <div class="panel panel-flat content">
        ...
        {!! Form::model($setting, formUpdateArray($setting, 'settings')) !!}
